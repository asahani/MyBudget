...
admin
==============
- Add icons to categories and master_categories
- Add info of show modal to all models in Admin
- review right content pane and helper texts and error messages
- possibly: edit & remove additional payee description in edit payee
- Update Radio buttons and check boxes as per new UI
...
- Tasks
- Scheduled Transactions with calendar view
- Error pages
- Budget dashboard including progress map
...
- Different account type features
  ...
  - Account Image
- Setup screen
- Payees - Icons or images
- Transaction tags for searching
- Payee details like Address book UI
- Timeline for year
- Calendar
- Lock screen for no access
- Login and registration
- Goals
- Other people sheets like pravesh and rajat
- Loans
