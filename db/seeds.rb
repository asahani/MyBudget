...
Payee.create!(name: 'Share Purchase', description: 'Share Sale Purchase', category_id: 7,is_system: true) #Should always be Fifth
Payee.create!(name: 'House Purchase', description: 'House Sale Purchase', category_id: 7,is_system: true) #Should always be Fifth
#---------------------------
