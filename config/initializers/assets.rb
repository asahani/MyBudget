...
%w( account_types accounts budget_incomes budget_items budget_transactions budgets categories import_transactions incomes master_categories payees tasks houses).each do |controller|
